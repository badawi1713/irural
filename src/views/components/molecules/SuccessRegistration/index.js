...
const SuccessRegistration = () => {
    return (
        <div className='w-full space-y-6 flex-col flex items-center'>
            ...
            <Link className='w-full lg:w-auto' to='/'><button className='w-full py-4 px-6 bg-gradient-to-r from-blue-400 to-blue-600 rounded-md hover:from-blue-500 hover:to-blue-700'>
